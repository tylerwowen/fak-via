...
// ===================================================================================
#define PIN_input(PIN)   ((PIN>=P10)&&(PIN<=P17) ? (P1_DIR_PU &= ~(1<<(PIN&7)), P1_MOD_OC &= ~(1<<(PIN&7))) :   ((PIN>=P30)&&(PIN<=P37) ? (P3_DIR_PU &= ~(1<<(PIN&7)), P3_MOD_OC &= ~(1<<(PIN&7))) : (0)))
...
// ===================================================================================
#define PIN_input_PU(PIN)   ((PIN>=P10)&&(PIN<=P17) ? (P1_MOD_OC |= (1<<(PIN&7)), P1_DIR_PU |= (1<<(PIN&7))) :   ((PIN>=P30)&&(PIN<=P37) ? (P3_MOD_OC |= (1<<(PIN&7)), P3_DIR_PU |= (1<<(PIN&7))) : (0)))

// ===================================================================================
// Set pin as OUTPUT (push-pull)
// ===================================================================================
#define PIN_output(PIN)   ((PIN>=P10)&&(PIN<=P17) ? (P1_MOD_OC &= ~(1<<(PIN&7)), P1_DIR_PU |= (1<<(PIN&7))) :   ((PIN>=P30)&&(PIN<=P37) ? (P3_MOD_OC &= ~(1<<(PIN&7)), P3_DIR_PU |= (1<<(PIN&7))) : (0)))

// ===================================================================================
// Set pin as OPEN-DRAIN OUTPUT (also high-impedance input, no pullup)
// ===================================================================================
#define PIN_output_OD(PIN)   ((PIN>=P10)&&(PIN<=P17) ? (P1_MOD_OC |= (1<<(PIN&7)), P1_DIR_PU &= ~(1<<(PIN&7))) :   ((PIN>=P30)&&(PIN<=P37) ? (P3_MOD_OC |= (1<<(PIN&7)), P3_DIR_PU &= ~(1<<(PIN&7))) : (0)))
...
// ===================================================================================
#define WAKE_PIN_enable(PIN)   ((PIN == P13) ? (WAKE_CTRL |= bWAK_P1_3_LO) :   ((PIN == P14) ? (WAKE_CTRL |= bWAK_P1_4_LO) :   ((PIN == P15) ? (WAKE_CTRL |= bWAK_P1_5_LO) : (0)))))

#define WAKE_PIN_disable(PIN)   ((PIN == P13) ? (WAKE_CTRL &= ~bWAK_P1_3_LO) :   ((PIN == P14) ? (WAKE_CTRL &= ~bWAK_P1_4_LO) :   ((PIN == P15) ? (WAKE_CTRL &= ~bWAK_P1_5_LO) : (0)))))

// ===================================================================================
// Start PWM on pin, must be a PWM-capable pin: (P15 or P30) and (P34 or P31)
// ===================================================================================
#define PWM_start(PIN)   ((PIN == P15) ? (PWM_CTRL &= ~bPWM_CLR_ALL, PIN_FUNC &= ~bPWM1_PIN_X, PWM_CTRL |= bPWM1_OUT_EN) :   ((PIN == P34) ? (PWM_CTRL &= ~bPWM_CLR_ALL, PIN_FUNC &= ~bPWM2_PIN_X, PWM_CTRL |= bPWM2_OUT_EN) :   ((PIN == P30) ? (PWM_CTRL &= ~bPWM_CLR_ALL, PIN_FUNC |=  bPWM1_PIN_X, PWM_CTRL |= bPWM1_OUT_EN) :   ((PIN == P31) ? (PWM_CTRL &= ~bPWM_CLR_ALL, PIN_FUNC |=  bPWM2_PIN_X, PWM_CTRL |= bPWM2_OUT_EN) : (0)))))

// ===================================================================================
// Set PWM output active level duty cycle on pin
// ===================================================================================
#define PWM_write(PIN, val)   ((PIN == P15) ? (PWM_DATA1 = val) :   ((PIN == P34) ? (PWM_DATA2 = val) :   ((PIN == P30) ? (PWM_DATA1 = val) :   ((PIN == P31) ? (PWM_DATA2 = val) : (0)))))

// ===================================================================================
// Stop PWM on pin
// ===================================================================================
#define PWM_stop(PIN)   ((PIN == P15) ? (PWM_CTRL &= ~bPWM1_OUT_EN) :   ((PIN == P34) ? (PWM_CTRL &= ~bPWM2_OUT_EN) :   ((PIN == P30) ? (PWM_CTRL &= ~bPWM1_OUT_EN) :   ((PIN == P31) ? (PWM_CTRL &= ~bPWM2_OUT_EN) : (0)))))

// ===================================================================================
// Set normal PWM polarity on pin (default low and active high)
// ===================================================================================
#define PWM_pol_normal(PIN)   ((PIN == P15) ? (PWM_CTRL &= ~bPWM1_POLAR) :   ((PIN == P34) ? (PWM_CTRL &= ~bPWM2_POLAR) :   ((PIN == P30) ? (PWM_CTRL &= ~bPWM1_POLAR) :   ((PIN == P31) ? (PWM_CTRL &= ~bPWM2_POLAR) : (0)))))

// ===================================================================================
// Set reverse PWM polarity on pin (default high and active low)
// ===================================================================================
#define PWM_pol_reverse(PIN)   ((PIN == P15) ? (PWM_CTRL |= bPWM1_POLAR) :   ((PIN == P34) ? (PWM_CTRL |= bPWM2_POLAR) :   ((PIN == P30) ? (PWM_CTRL |= bPWM1_POLAR) :   ((PIN == P31) ? (PWM_CTRL |= bPWM2_POLAR) : (0)))))

// ===================================================================================
// Set global PWM frequency (in Hertz, range: FREQ_SYS/65536 - FREQ_SYS/256)
// ===================================================================================
#define PWM_set_freq(FREQ)   (((FREQ) >= FREQ_SYS / 256) ? (PWM_CK_SE = 0)              :   (((FREQ_SYS / 256 / (FREQ) - 1) > 255) ? (PWM_CK_SE = 255) :   (PWM_CK_SE = (uint8_t)(FREQ_SYS / 256 / (FREQ) - 1))         ))

// ===================================================================================
// Pin to ADC channel conversion (P11, P14, P15, P32 only)
// ===================================================================================
#define ADC_channel(PIN)   ((PIN == P11) ? (0) :   ((PIN == P14) ? (1) :   ((PIN == P15) ? (2) :   ((PIN == P32) ? (3) : (0)))))
...
#define ADC_input(PIN)   ((PIN == P11) ? (ADC_CHAN1 = 0, ADC_CHAN0 = 0) :   ((PIN == P14) ? (ADC_CHAN1 = 0, ADC_CHAN0 = 1) :   ((PIN == P15) ? (ADC_CHAN1 = 1, ADC_CHAN0 = 0) :   ((PIN == P32) ? (ADC_CHAN1 = 1, ADC_CHAN0 = 1) : (0)))))
...
// ===================================================================================
#define CMP_channel(PIN)   ((PIN == P14) ? (0) :   ((PIN == P32) ? (1) : (0)))
...
#define CMP_negative(PIN)  ((PIN == P14) ? (CMP_CHAN = 0) :   ((PIN == P32) ? (CMP_CHAN = 1) : (0)))